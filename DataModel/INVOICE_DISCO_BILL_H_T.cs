...
namespace DataModel
{
    ...
    public partial class INVOICE_DISCO_BILL_H_T
    {
        ...
        public Nullable<double> NEO_TOTAL { get; set; }
        public Nullable<double> KVARH { get; set; }
        ...
        public Nullable<double> TOTAL_MDI { get; set; }
        public Nullable<double> TOTAL_NEO { get; set; }
    }
}
